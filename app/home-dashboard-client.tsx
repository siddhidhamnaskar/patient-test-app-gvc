        ...
        <div className="mx-auto flex max-w-7xl h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            {(currentUser.role === "superadmin" || currentUser.role === "admin") && (
              <Link
                href="/admin"
                className="hidden sm:inline-flex items-center gap-1.5 rounded-xl border border-teal-200 bg-teal-50/40 px-3.5 py-1.5 text-xs font-bold text-teal-800 shadow-sm transition-all hover:bg-teal-50 hover:border-teal-350 active:scale-95 cursor-pointer"
              >
